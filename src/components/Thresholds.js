...
// })
    ...
    checkRoadblock() = () => { 
        axios.get("https://cruise-extension.herokuapp.com/api/roadblock", {port:80}).then(res => {
            if (res.data[0] == 'True') {
    ...
    checkCompletion = () => {
        axios.get("https://cruise-extension.herokuapp.com/api/completion", {port:80}).then(res => {
            if (res.data[0] == 'True') {
