...
quarter_backward_difference_mean = feature_mean_q(first_sliced_matrix, second_sliced_matrix, third_sliced_matrix,
                                                  fourth_sliced_matrix)
...
quarter_backward_difference_max = feature_max_q(first_sliced_matrix, second_sliced_matrix, third_sliced_matrix,
                                                fourth_sliced_matrix)
...
quarter_backward_difference_min = feature_min_q(first_sliced_matrix, second_sliced_matrix, third_sliced_matrix,
                                                fourth_sliced_matrix)
...
feature_vector = generate_feature_vectors_from_samples(filepath, 60, 1, state=None, remove_redundant=True,
                                                       cols_to_ignore=None)
