...
export declare const cachedReaddir: (cache: FsCache, path: string, options: import("fs").BaseEncodingOptions & {
    withFileTypes: true;
}) => Promise<import("fs").Dirent[]>;
export declare const cachedReadFile: (cache: FsCache, path: string, options?: BufferEncoding | (import("fs").BaseEncodingOptions & {
